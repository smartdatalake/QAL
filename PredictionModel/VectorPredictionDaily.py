...
modelDir = "models/"
setup = [("2YearTo2Week", 1000, 32, 20), ("4YearTo2Week", 400, 32, 20), ("1YearTo1Month", 1000, 32, 25)
    , ("4YearTo6Month", 30, 32, 12), ("6MonthTo1Month", 1000, 32, 30), ("3MonthTo1Month", 1000, 32, 30), ("2YearTo1Year", 100, 32, 20), ("4YearTo1Year", 100, 32, 20), ("4YearTo2Year", 100, 32, 20)]
#
...
for (tag, modelNumber, batchSize, nbEpoch) in setup:
    ...
    for index in range(1, modelNumber):
        ...
        onlyfiles = [f for f in listdir(parentDir) if (isfile(join(parentDir, f)) and f.__contains__(testFile) and f.__contains__("_day"))]
        ...
        for (windowSize, predictionSize) in [(10, 10)]:
            ...
            out += modelName + "_" + str(round(cp)) + "_" + str(round(scores[1] * 100)) + "_" + str(
                round(scores[2] * 100)) + "_" + str(round(scores[3] * 100)) + "_" + str(round(scores[4] * 100)) + "\n"
    ...
    file_object = open('MLResult.txt', 'a')
